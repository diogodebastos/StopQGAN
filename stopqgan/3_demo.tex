...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=0.49\textwidth]{../assets/bloch1.pdf}
    \includegraphics[width=0.49\textwidth]{../assets/bloch2.pdf} \\
    \includegraphics[width=0.49\textwidth]{../assets/bloch_event680_1.pdf}
    \includegraphics[width=0.49\textwidth]{../assets/bloch_event680_2.pdf} \\
...
We can now compare the real data with the generated one in Figure~\ref{fig:bloschres680} 
